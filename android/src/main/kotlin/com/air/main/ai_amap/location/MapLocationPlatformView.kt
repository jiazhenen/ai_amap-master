...
//                val startlatitude: Double = call.argument("startlatitude")!!;
//                val startname: Double = call.argument("startname")!!;
//                val startlongitude: Double = call.argument("startlongitude")!!;

                val endlatitude: Double = call.argument("endlatitude")!!;
                val endname: String = call.argument("endname")!!;
                val endlongitude: Double = call.argument("endlongitude")!!;
                showAMapNavigatorPages( endtname = endname,endlatitude = endlatitude,endlongitude= endlongitude
//                        startname = startname,startlatitude =startlatitude,startlongitude = startlongitude,
                                       );
            }
            "addGeoFence" -> {
                val latitude: Double = call.argument("latitude")!!;
...
//    }
    ...
    // private fun addGeoFence(latitude: Double, longitude: Double, radius: Float, customId: String) {
    private fun showAMapNavigatorPages(endtname:String,endlatitude: Double, endlongitude: Double
//            startname:String,startlatitude: Double, startlongitude: Double,
                                        ) {
        //可通过AMapNavi.setUseInnerVoice(true) 开启内置语音功能
        //起点
        //起点
//        val start = Poi(startname, LatLng(startlatitude, startlongitude), "B000A28DAE")
//途经点
//途经点
//        val poiList: List<Poi> = ArrayList()
//        poiList.add(Poi("故宫", LatLng(39.918058, 116.397026), "B000A8UIN8"))
//终点
//终点
        val end =  Poi(endtname, LatLng(endlatitude, endlongitude), "B000A816R6")
// 组件参数配置
// 组件参数配置
